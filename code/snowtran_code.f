...
c   the simulation domain.  If it is a Lagrangian sea ice run
c   with 25-km grid cells, just adjust the snow depth in response
c   to the blowing snow sublimation fluxes.
      if (seaice_run.eq.1.0 .or. seaice_run.eq.4.0 .and.
     &  deltax.eq.25000.0) then
