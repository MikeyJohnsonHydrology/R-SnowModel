!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!                                                             
!   snow_remap.F90 - part of the Community Ice Sheet Model (CISM)  
!                                                              
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
...
! save
! private
! public :: dp,glissade_horizontal_remap,make_remap_mask,puny,nhalo
  public :: dp,puny
...
!        write (6,*) 'Aborting (task = ',this_rank,')'
         write (6,*) 'Aborting (task = 0)'
         write (6,*) 'Incremental remapping scheme failed. A CFL'
         write (6,*) '  violation has likely occurred. See the log'
         write (6,*) '  file for more information.'
         stop
      endif
      ...
      do i = ilo-nghost, ihi+nghost-1
         ...
         if (dpx(i,j) < -htn(i,j) .or. dpx(i,j) > htn(i+1,j) .or.   &
            ...
            !WHL - debug
              ...
              print*, 'uvel, vvel =',uvel(i,j),vvel(i,j)
