...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &  vegsnowd_xy,deltax,snow_depth,Lr
...
c      xImax = 14.0 * forest_LAI !adjusted for Andreadis-Stork 35mm max swe intercepted
      ...
      if(Tair.ge.272.15)then
        Lr = 4.0
      endif
      if(Tair.le.270.15)then
        Lr = 1.0
      endif
...
c Seprate print statments for each element, mj
        ...
        print*,'swe_depth_old =', swe_depth_old
        print*,'swe_depth =', swe_depth
        print*,'prec =', prec
        print*,'runoff =', runoff
        print*,'glacier_melt =', glacier_melt
        print*,'swesublim =', swesublim
        print*,'canopy_int_old =', canopy_int_old
        print*,'canopy_int =', canopy_int
        print*,'Qcs =', Qcs
